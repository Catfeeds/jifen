...
<body>
	<div class="container">
		...
		<div class="weui_cells weui_cells_access">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><!-- <a class="weui_cell coad_lnfo_bage
" href="<?php echo U('Distribution/memberList',array(ids=>$list['ids']));?>"> -->
