...
<body>
	<div class="container" id="agent_transfer">
      ...
      <div class="weui_cells_form" style="padding-top: 10px;">
        ...
        <div class="weui_cell">
          <div class="weui_cell_bd weui_cell_primary weui_cell_infoedit" style="box-shadow: 0 0 5px #D6D6D6;">
            <input id="info_edit_item" class="weui_input weui_input_infoedit red" type="text" placeholder="输入红色咪豆额度" value="0">
            <span class="weui_infoedit_delete">×</span>
          </div>
        </div>
        <div class="weui_cells weui_cells_form" style="margin: 16px;box-shadow: 0 0 5px #D6D6D6;border-radius: 6px;">
          <div class="weui_cell">
            <div class="weui_cell_bd weui_cell_primary">
              <textarea class="weui_textarea transfer_remark" placeholder="备注:" rows="3" id="weui_textarea"></textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="weui_cells" style="padding: 0 10px; background-color: rgba(255,255,255,0);">
        <a href="javascript:;" class="weui_btn weui_btn_primary save_info">确认转账</a>
      </div>
	</div>
</body>
</html>