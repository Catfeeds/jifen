    ...
    <div class="bd">
      <div class="weui_cells weui_cells_access" style="margin-top: 5px;">
        <a class="weui_cell" href="javascript:;">
          ...
          <div class="">
            <img id="headimg" style="width: 40px; height: 40px; border-radius: 50%;" src="<?php echo ($agent["headimgurl"]); ?>"></div>
        ...
        <a class="weui_cell" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">代理点名称</p>
          </div>
          <div class=" editinfo_con"><?php echo ($agent["name"]); ?></div>
        </a>
        <a class="weui_cell" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">我的推荐码</p>
          </div>
          <div class=" editinfo_con"><?php echo ($agent["code"]); ?></div>
        </a>
        <a class="weui_cell" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">代理点账号</p>
          </div>
          <div class=" editinfo_con"><?php echo ($agent["username"]); ?></div>
        </a>
        <a class="weui_cell editinfo_btn" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">身份证</p>
          </div>
          <div class="weui_cell_ft editinfo_con" data-name="idCard"><?php echo ($agent["idCard"]); ?></div>
        </a>
        <a class="weui_cell editinfo_btn" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">电话</p>
          </div>
          <div class="weui_cell_ft editinfo_con" data-name="tele"><?php echo ($agent["tele"]); ?></div>
        </a>
        <a class="weui_cell editinfo_btn" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
            <p class="editinfo_title">收货地址</p>
          </div>
          <div class="weui_cell_ft editinfo_con" data-name="address"><?php echo ($agent["address"]); ?></div>
        </a>
        <a class="weui_cell editinfo_btn" href="javascript:;">
          <div class="weui_cell_bd weui_cell_primary">
