...
<title>他的<?php echo ($level); ?>分店-分店列表</title>
...
<body>
	<div class="container">
	<?php if(is_array($childmember)): $i = 0; $__LIST__ = $childmember;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div <?php if(($vo["distritime"]) != "0"): ?>class="fd fd1"<?php else: ?>class="fd"<?php endif; ?>>
        ...
        <div class="right"><img src="<?php echo RES;?>/distri/images/xin.png"></div><!--right-->
        <div class="clear"></div>
