	...
	<div class='container'>
		...
		<form action="<?php echo U('Distribution/topupSubmit');?>" method="post" id="topup_form">
			<div class="weui_cells weui_cells_form">
				<div class="weui_cell">
					<div class="weui_cell_hd">
						<label class="weui_label">充值绿色咪豆</label>
					</div>
					<div class="weui_cell_bd weui_cell_primary">
						<input class="weui_input" type="tel" id="gold_num" name="green" placeholder="输入充值咪豆"></div>
				</div>
			</div>
			<div class="weui_cell weui_cell_select">
			  <div class="weui_cell_bd weui_cell_primary">
			    <select class="weui_select" name="distribution" id="account_topup_select_distribution">
			      <option selected="" value="0">选择配送次数</option>
			      <option value="3">3次配送</option>
			...
			<div class='demos-content-padded'>
				<a href="javascript:;" class="weui_btn weui_btn_disabled weui_btn_warn weui_btn_submit" id="member_topup" style="background-color: #f1bf64; color:#fff;">充值</a>
			</div>
		</form>
	</div>
