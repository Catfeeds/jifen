...
<div class="content">
          ...
          <div class="cLine">
          	...
          	<a href="<?php echo U('Article/add', array('token' => $token,'type'=>'add'));?>" title="新增文章" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增文章</a>
            <!-- <a href="<?php echo U('Article/classify', array('token' => $token));?>" title="新增文章" class="btnGrayS vm bigbtn">文章分类</a> -->
          	</div>
            <div class="pageNavigator" style="float:right;line-height: 6px;">
  　　      <span>
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td class="norightborder">
                    <a href="<?php echo U('Article/set',array('token'=>$token,'id'=>$list['id']));?>">修改</a>
                    <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Article/del',array('id'=>$list['id'],'token'=>$token));?>');">删除</a>
                  </td>
