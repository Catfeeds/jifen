          ...
          <th>操作</th>
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td><?php echo ($list["account"]["id"]); ?></td>
                  <td><?php echo ($list["account"]["username"]); ?></td>
                  <td style="color: green;"><?php echo ($list["green"]); ?></td>
                  <td><?php echo ($list["black"]); ?></td>
                  <td style="color: red;"><?php echo ($list["topup"]); ?></td>
                  <td><?php echo ($list['green'] + $list['black'] + $list['topup']); ?></td>
                  <td style="color: blue;"><?php echo ($list["need_integral"]); ?></td>
                  <td>
                    <?php if(($list["back"]) == "1"): ?>是<?php else: ?>否<?php endif; ?>
                  </td>
