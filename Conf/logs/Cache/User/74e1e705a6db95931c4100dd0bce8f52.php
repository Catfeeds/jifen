          ...
          <th>操作</th>
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td><?php echo ($list["topup"]); ?></td>
                  <td><?php echo ($list["need_integral"]); ?></td>
                  <td>
                    <?php if(($list["return"]) == "1"): ?>申请退款<?php endif; ?> 
                    <?php if(($list["return"]) == "2"): ?>退款完成<?php endif; ?> 
                  </td>
                  <td><?php echo (date('Y-m-d H:i:s',$list["addtime"])); ?></td>
                  <td class="norightborder">
                    <?php if(($list["finish"]) != "1"): ?><a href="<?php echo U('Distribution/topupRecord',array('id'=>$list['id'],'type'=>'return'));?>" title="反红色积分">反红色积分</a><?php endif; ?>
