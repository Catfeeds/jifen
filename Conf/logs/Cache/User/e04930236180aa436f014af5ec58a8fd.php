              ...
              <tbody>
                <tr></tr>
                  ...
                  <td class="norightborder">
                    ...
                    <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Distribution/deleteAccount',array('id'=>$list['id']));?>');" title="设置上级">删除</a>
                  </td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
      			         <script>
                  function bindupaccount(id){
                    art.dialog.open('<?php echo U('Distribution/bindupaccount',array('token'=>$token,'dining'=>$isDining,'id'=>"'+id+'"));?>',{lock:false,title:'设置上级',width:1000,height:620,yesText:'关闭',background: '#000',opacity: 0.87,close: function(){location.reload();}});
                  }
                  </script>          
