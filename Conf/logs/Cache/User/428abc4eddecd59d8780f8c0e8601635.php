...
<div class="content">
  ...
  <div class="cLineB">
    <h4 class="left" style="color: red;">代理点:<?php echo ($agent["name"]); ?>&nbsp;总收入:<?php echo ($red); ?>&nbsp;
        <a href="<?php echo U('Distribution/agent',array('type'=>transferpage,'id'=>$agent['id']));?>">
          <input type="submit" class="btnGrayS" value="转账">
        </a>
      <a href="<?php echo U('Distribution/agent',array('type'=>transferDetails,'id'=>$agent['id']));?>">
        <input type="submit" class="btnGrayS" value="明细" style="display: inline-block;">
      </a>
    </h4>
  </div>
  <div class="cLine">
    <div class="pageNavigator">
      <span>
        <form action="<?php echo U('Distribution/agent',array('type'=>'earndetails','id'=>$agent['id']));?>" method="post" style="float: left;">
          关键词：
