...
<div class="content">
  ...
  <div class="cLineB">
    <h4 class="left">代理点列表</h4>
  </div>
  <div class="cLine">
    <div class="pageNavigator">
      <a href="<?php echo U('Distribution/agent',array('type'=>'register'));?>" class="btnGrayS px">添加代理点</a>
      <span>
        <form action="" method="post" style="float: left;">
          关键词：
          <input type="text" name="name" class="px" value="<?php echo ($_REQUEST['name']); ?>" placeholder="输入代理点名">
          <input type="submit" class="btnGrayS" value="搜索"></form>
      </span>
      ...
      <tbody>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class="norightborder">
              <a href="<?php echo U('Distribution/agent',array('type'=>'edit','id'=>$list['id']));?>">修改</a>
              <a href="javascript:;" onclick="if(window.confirm('确定删除吗?')){location.href='<?php echo U('Distribution/agent',array('type'=>'delete','id'=>$list['id']));?>'}">删除</a>
              <a href="<?php echo U('Distribution/agent',array('type'=>'accountdetails','id'=>$list['id']));?>">账号明细</a>
              <a href="<?php echo U('Distribution/agent',array('type'=>'earndetails','id'=>$list['id']));?>">收入明细</a>
            </td>
