...
<td><p>会员充值：<?php echo (($admin_account["agreen"])?($admin_account["agreen"]):0); ?></p><p>后台充值：<?php echo (($admin_account["cgreen"])?($admin_account["cgreen"]):0); ?></p></td>
<td></td>
</tr>
...
<div class="content">
  ...
  <div class="cLineB">
    ...
    <a href="<?php echo U('Distribution/account',array('p'=>$_GET['p']));?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
  </div>
  ...
  <div class="msgWrap bgfc">
    <table class="userinfoArea" style=" margin:0;float:left" border="0" cellspacing="0" cellpadding="0" width="50%">
      <tbody>
        <tr>
          ...
          <td>
            <img src="<?php echo ($info["headimgurl"]); ?>" style="width: 80px;" alt=""></td>
        </tr>
        <tr>
          <th width="120">账号名：</th>
        ...
        <tr>
          ...
          <td>
            <span class="content_edit_item" data-name="nickname" style="display: inline-block;width: 102px;"><?php echo ($info["nickname"]); ?></span>
    ...
    color: #fff !important;"></td>
        ...
        <script src="<?php echo RES;?>/js/jquery-1.11.1.min.js"></script>
        <script>
          (function($){
            ...
            $(document).on('click','.content_edit_btn',function(){
              ...
              $(document).on('click','.content_edit_save',function(){
                ...
                console.log("<?php echo ($info["id"]); ?>");
                $.ajax({
                  url:"<?php echo U('Distribution/accountDetailEdit');?>",
                  data:{name:edit_name,con:edit_con,id:"<?php echo ($info["id"]); ?>"},
                  dataType:'json',
  ...
  <table class="userinfoArea" style=" margin:0;float:left" border="0" cellspacing="0" cellpadding="0" width="50%">
    <tbody>
      <tr>
        ...
        <td>
          <a href="<?php echo U('Distribution/accountEarnDetails',array('type'=>'green','id'=>$info['id']));?>" style="color: green;">
          <?php echo (($info["detail"]["green"])?($info["detail"]["green"]):0); ?>
          </a>
        </td>
      </tr>
      <tr>
        ...
        <td>
          <a href="<?php echo U('Distribution/accountEarnDetails',array('type'=>'red','id'=>$info['id']));?>" style="color: red;">
            <?php echo (($info["detail"]["red"])?($info["detail"]["red"]):0); ?>
          </a>
        </td>
      </tr>
      <tr>
        <th width="120">黑色咪豆:</th>
        <td><?php echo (($info["detail"]["black"])?($info["detail"]["black"]):0); ?></td>
      </tr>
      <tr>
        <th width="120">购买订单总数:</th>
        <td><?php echo (($info["detail"]["shoporders"])?($info["detail"]["shoporders"]):0); ?></td>
      </tr>
    </tbody>
  </table>
  ...
  <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
    ...
    <tbody>
      <tr></tr>
      <?php if(is_array($info["childs"])): $i = 0; $__LIST__ = $info["childs"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
          <td>
            <img src="<?php echo ($list["headimgurl"]); ?>" width="50"></td>
          <td><?php echo ($list["username"]); ?></td>
          <td><?php echo ($list["member"]["nickname"]); ?></td>
