...
<div class="content">
  ...
  　　      <span>
              ...
              关键词：
              <input type="text" name="name" class="px" value="<?php echo ($_REQUEST['name']); ?>" placeholder="输入账号">
          ...
          <th>收货地址</th>
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td><?php echo ($list["province"]); echo ($list["city"]); echo ($list["county"]); echo ($list["address"]); ?></td>
