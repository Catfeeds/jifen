...
<li class="tabli" id="tab2"><a href="<?php echo U('Store/guanggao',array('token'=>$token));?>">广告位图管理</a></li>
...
<a href="<?php echo U('Store/addNew', array('token' => $token, 'catid' => $catid,'parentid' => $_GET['parentid']));?>" title="添加" class="btnGrayS vm bigbtn">
<img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加商品</a>
</div><?php endif; ?>
<div class="pageNavigator right">
	<a href="<?php echo U('Store/index',array('token'=>$token,'catid'=>$catid,'parentid'=>$_GET['parentid']));?>" class="btnGrayS vm bigbtn">返回</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo ($hostlist["offerprice"]); ?>%</td>
...
<td class="norightborder" align="center">
	<a href="<?php echo U('Store/addNew',array('id' => $hostlist['id'], 'token' => $token,'catid' => $catid,'parentid' => $_GET['parentid']));?>">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;
