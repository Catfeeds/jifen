...
<script type="text/javascript">
  ...
  <div class="content"> 
   ...
   <form class="form" method="post" action="<?php echo U('Distribution/greenTopup');?>"> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        <th>绿色咪豆:</th> 
        <td><?php echo (($info["green"])?($info["green"]):0); ?></td> 
       </tr>
       <tr> 
        <th>充值绿色咪豆:</th> 
        <input type="hidden" name="aid" value="<?php echo ($info["id"]); ?>">
        <td>
          <input class="px" type="text" name="green">
        </td> 
       </tr>
       <tr> 
        <th>选择配送次数:</th> 
        <td>
          <select name="distribution" id="distribution">
            <option value="0">==选择配送次数</option>
            <option value="6">6次配送</option>
            <option value="12">12次配送</option>
            <option value="24">24次配送</option>
          </select>
        </td> 
       </tr>
       <tr>         
