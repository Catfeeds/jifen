...
<script type="text/javascript">
  ...
  <div class="content"> 
   <div class="cLineB"> 
    <h4>编辑代理点</h4> 
    <a href="<?php echo U('Distribution/agent',array('p'=>$_GET['p']));?>" class="right  btnGreen" style="margin-top:-27px">返回</a> 
   </div> 
   <form class="form" method="post" action="<?php echo U('Distribution/agent_edit');?>"> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <tr> 
        <th>代理点名:</th> 
        <td>
          <input class="px" type="text" name="name" value="<?php echo ($info["name"]); ?>">
        </td> 
       </tr>
       <tr> 
        <th>账号:</th> 
        <td> 
          <input class="px" type="text" name="username" value="<?php echo ($info["username"]); ?>">
        </td> 
       </tr>
       <tr> 
        <th>密码:</th> 
        <td>
          <input class="px" type="password" name="password" value="<?php echo ($info["password"]); ?>">
        </td> 
       </tr>
       <tr> 
        <th>身份证:</th> 
        <td>
          <input class="px" type="text" name="idCard" value="<?php echo ($info["idCard"]); ?>">
        </td> 
       </tr>
       <tr> 
        <th>电话:</th> 
        <td>
          <input class="px" type="text" name="tele" value="<?php echo ($info["tele"]); ?>">
        </td> 
       </tr>
       <tr> 
        <th>收货地址:</th> 
        <td>
          <input class="px" type="text" name="address" value="<?php echo ($info["address"]); ?>">
        </td> 
       </tr>
       <tr>         
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btnGreen">保存</button> &nbsp; <a href="<?php echo U('Distribution/account',array('token'=>$token,'p'=>$_GET['p']));?>" class="btnGray vm">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
