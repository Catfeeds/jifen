...
<script type="text/javascript">
  ...
  <div class="content"> 
   ...
   <form class="form" method="post" action="<?php echo U('Distribution/accountTopup');?>"> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        <th>订单价格:</th> 
        <td><?php echo (($info["price"])?($info["price"]):0); ?></td> 
       </tr>
       <tr> 
        <th>已冲红色咪豆:</th> 
        <td><?php echo (($info["topup_integral"])?($info["topup_integral"]):0); ?></td> 
       </tr>
       <tr> 
        <th>还需红色咪豆:</th> 
        <td><?php echo (($info["need_integral"])?($info["need_integral"]):0); ?></td> 
       </tr>
       <tr> 
        <th>补贴红色咪豆:</th> 
        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
        <td>
          <input class="px" type="text" name="gold">
        </td> 
       </tr>
       <tr>         
       <th>&nbsp;</th>
