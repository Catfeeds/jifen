...
<div class="content">
          ...
          <div class="cLineB">
			<h4 class="left"><?php echo ($username); ?>绿色积分收入</h4>
			</div>
                <!-- <div class="cLine">
          ...
          <th>时间</th>
              ...
              <tbody>
                <tr></tr>
                  ...
                  <td><?php echo ($list["oprationer"]["id"]); ?></td>
                  <td><?php echo ($list["oprationer"]["username"]); ?></td>
                  <td style="color:green;"><?php echo ($list["green"]); ?></td>
                  <td>
                    <?php switch($list["status"]): case "1": ?>下级充值<?php break;?>
                      <?php case "2": ?>下下级充值<?php break;?>
                      <?php case "3": ?>代理收益<?php break;?>
                      <?php case "4": ?>充值返给公司<?php break;?>
                      ...
                      <?php case "12": ?>没有上级返给公司<?php break;?>
                      <?php case "13": ?>没有上上级返给公司<?php break;?>
